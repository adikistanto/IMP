...
<body>
	...
	<div id="wrapper" style="background-color: #F7F6E8;box-shadow: 3px 3px 3px 3px #888888;border-radius:40px;">
		<div id="panel_title" class="panel_title_left" style="border-radius:15px;margin-left:0px; margin-top:100px;">
			<h1 >
					<?php echo $news_id->title_news;?>
			</h1>
		</div>
		<div id="divclear"></div>
		<div id="content_box_big" class="big_left" style="border-right:1px solid #FA243D">
			<p class="author_box" style="width:88%">posted by : <?php echo $news_id->author_news; ?>, <?php echo $news_id->date_news; ?></p>
			<p style="text-align:left; width:90%;line-height: 150%;font-size:15px">		
				<?php echo $news_id->content_news; ?>
			</p>
		</div>
		<div id="content_box_mini" class="big_left">
			<h2 >Other News...</h2>
			<ul style="list-style:none; padding-left:10px; width:80%">
				<li style="border-bottom:1px solid #FA243D"><p class="bold">Judul Berita</p></li>
				<li style="border-bottom:1px solid #FA243D"><p class="bold">Tapi mohon maaf pembelaannya tadi mungkin tidak sesuai dengan fakta-fakta yang ada</h4></li>
				<li style="border-bottom:1px solid #FA243D"><p class="bold">Judul Berita</p></li>
				<li style="border-bottom:1px solid #FA243D"><p class="bold">Judul Berita</p></li>
				<li style="border-bottom:1px solid #FA243D"><p class="bold">Judul Berita</p></li>
			</ul>
